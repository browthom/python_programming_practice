...
# of 100 or 200. Note: abs(num) computes the absolute
# value of a number.
##
def near_hundred(n):
...
def pos_neg(a, b, negative):
    return (((a < 0) ^ (b < 0)) and not negative) or (a < 0 and b < 0 and negative)
...
# original string (i.e. n will be in the range 0..len(str)-1
# inclusive).
##
...
##
def front3(string):
    return string[:3] + string[:3] + string[:3]
